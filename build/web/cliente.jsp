<%-- 
    Document   : cliente
    Created on : 26/06/2020, 04:02:08 PM
    Author     : benja
--%>
...
<html>
  ...
  <a class="navbar-brand" href="mostrar.jsp">Tienda Cerveza</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
       <li class="nav-item dropdown">
        ...
        <%
            ...
            if (nombre != null) {
                if (nombre.getPerfil().getDescripcion().equals("Cliente")) {
                    int categoria = 0;
    ...
    <c:forEach items="${categoria}" var="tmp">
            <a href="cliente.jsp?categoria=${tmp.id}">${tmp.descripcion}</a>
        </c:forEach>
        <a href="cliente.jsp?categoria=0">Mostrar todo</a>
        <a href="cliente.jsp">Mostrar todo</a>
